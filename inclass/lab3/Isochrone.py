...
plt.plot(data2['B']-data2['R'], data2['R'], color='black', linewidth=5, label='1 Gyr')
plt.plot(data3['B']-data3['R'], data3['R'], color='red', linewidth=5, label='1 Gyr')
plt.plot(data4['B']-data4['R'], data4['R'], color='green', linewidth=5, label='1 Gyr')
plt.plot(data5['B']-data5['R'], data5['R'], color='orange', linewidth=5, label='1 Gyr')
plt.plot(data6['B']-data6['R'], data6['R'], color='purple', linewidth=5, label='1 Gyr')
plt.plot(data7['B']-data7['R'], data7['R'], color='brown', linewidth=5, label='1 Gyr')
plt.plot(data8['B']-data8['R'], data8['R'], color='cyan', linewidth=5, label='1 Gyr')
plt.plot(data9['B']-data9['R'], data9['R'], color='yellow', linewidth=5, label='1 Gyr')
plt.plot(data10['B']-data10['R'], data10['R'], color='grey', linewidth=5, label='1 Gyr')
plt.plot(data11['B']-data11['R'], data11['R'], color='navy', linewidth=5, label='1 Gyr')
plt.plot(data12['B']-data12['R'], data12['R'], color='plum', linewidth=5, label='1 Gyr')
plt.plot(data13['B']-data13['R'], data13['R'], color='lime', linewidth=5, label='1 Gyr')
